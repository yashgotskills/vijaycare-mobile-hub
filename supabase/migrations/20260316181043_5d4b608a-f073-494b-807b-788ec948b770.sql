...
ADD COLUMN IF NOT EXISTS family_tag text;

CREATE INDEX IF NOT EXISTS idx_products_family_tag ON public.products(family_tag);
...
BEGIN
  ...
  INSERT INTO public.products (
    ...
    is_featured, is_new, is_bestseller, images, family_tag
  ) VALUES (
    _product_data->>'name',
    _product_data->>'slug',
    ...
    NULLIF(_product_data->>'family_tag', '')
  )
...
BEGIN
  ...
  UPDATE public.products SET
    ...
    family_tag = NULLIF(_product_data->>'family_tag', ''),
    updated_at = now()
